...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-green-700 flex items-center justify-center px-6 text-center">
      <div>
        ...
        <p className="text-green-200 mb-8 max-w-sm mx-auto">
          This page doesn't exist yet — but every great initiative starts somewhere. Let's get you back on track.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="px-7 py-3 bg-amber-500 hover:bg-amber-400 text-white font-bold rounded-xl transition-all"
          >
            Go Home
          </Link>
          <Link
